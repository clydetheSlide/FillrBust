...
#       o provide command-line option to disable renderring
#  dev:
...
#    draw dice nicer
#       o group retained dice seperately from rolled dice
#       o provide means to disable/enable renderring
...
class App:
    ...
    def reinit(self, master \
        ...
        self.card.pack(side=Ttk.RIGHT,anchor='w')
        Ttk.Label(self.cardframe,text='',bg='black',fg='white').pack(side=Ttk.RIGHT,expand=1)
...
def seeTableDice(dicestr='0',selected=[]):
    # see tableDice.pov for instructions for cococting the dice description string
    num=0
...
if __name__ == '__main__':
    ...
    for opt, par in options:
        if opt == '-d':
            ...
            carddir="Cards/%s"%par
            dtw=Image.open('%s/title.gif'%carddir).size[1]*1.333
